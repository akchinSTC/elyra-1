...
class KfpPipelineProcessor(RuntimePipelineProcessor):
    ...
    def _cc_pipeline(self,
        ...
        for operation in sorted_operations:
            ...
            # If operation is one of the "standard" set of NBs or scripts, construct custom ExtendedContainerOp
            if operation.classifier in ["execute-notebook-node", "execute-python-node", "execute-r-node"]:
                ...
                notebook_ops[operation.id] = ExtendedContainerOp(name=sanitized_operation_name,
                                                                 pipeline_name=pipeline_name,
                                                                 experiment_name=experiment_name,
