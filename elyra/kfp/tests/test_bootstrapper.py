...
#
# NOTE: Any changes to elyra/kfp/tests/resources/test-notebookA.ipynb require an
# update of elyra/kfp/tests/resources/test-archive.tgz  using the command below:
...
def main_method_setup_execution(monkeypatch, s3_setup, tmpdir, argument_dict):
    ...
    s3_setup.fput_object(bucket_name=argument_dict['cos-bucket'],
                         ...
                         file_path="elyra/kfp/tests/resources/test-requirements-elyra.txt")
    s3_setup.fput_object(bucket_name=argument_dict['cos-bucket'],
                         object_name="test-directory/test,file.txt",
                         file_path="elyra/kfp/tests/resources/test-bad-requirements-elyra.txt")
    s3_setup.fput_object(bucket_name=argument_dict['cos-bucket'],
                         object_name="test-directory/test-archive.tgz",
                         file_path="elyra/kfp/tests/resources/test-archive.tgz")
...
def test_main_method(monkeypatch, s3_setup, tmpdir):
    argument_dict = {'cos-endpoint': 'http://' + MINIO_HOST_PORT,
                     ...
                     'filepath': 'elyra/kfp/tests/resources/test-notebookA.ipynb',
...
def test_fail_bad_notebook_main_method(monkeypatch, s3_setup, tmpdir):
    argument_dict = {'cos-endpoint': 'http://' + MINIO_HOST_PORT,
                     ...
                     'filepath': 'elyra/kfp/tests/resources/test-bad-notebookB.ipynb',
                     'inputs': 'test-file.txt',
    ...
    s3_setup.fput_object(bucket_name=argument_dict['cos-bucket'],
                         ...
                         file_path="elyra/kfp/tests/resources/test-bad-archiveB.tgz")
...
def test_convert_notebook_to_html(tmpdir):
    notebook_file = os.getcwd() + "/elyra/kfp/tests/resources/test-notebookA.ipynb"
...
def test_fail_convert_notebook_to_html(tmpdir):
    notebook_file = os.getcwd() + "/elyra/kfp/tests/resources/test-bad-notebookA.ipynb"
...
def test_find_best_kernel_nb(tmpdir):
    source_nb_file = os.path.join(os.getcwd(), "elyra/kfp/tests/resources/test-notebookA.ipynb")
...
def test_requirements_file():
    requirements_file = "elyra/kfp/tests/resources/test-requirements-elyra.txt"
...
def test_fail_requirements_file_bad_delimiter():
    bad_requirements_file = "elyra/kfp/tests/resources/test-bad-requirements-elyra.txt"
